...
public interface AuthApi {
    ...
    @Operation(
            ...
            description = "Creates a new user account with PATRON role"
    )
    @ApiResponse(
            responseCode = "201",
    ...
    @Operation(
            summary = "Register a user with any role (Admin only)",
    ...
    @Operation(
            ...
            description = "Provides a JWT token for API access"
    )
    @ApiResponse(
            responseCode = "200",
